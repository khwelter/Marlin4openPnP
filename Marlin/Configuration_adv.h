...
#define HOMING_BUMP_MM      { 1, 1, 5, 1, 1, 5, 1, 1 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 2, 2, 2, 2, 2, 2 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 2, 2, 2, 2, 2, 2, 2, 2 }  // (linear=mm, rotational=°) Backoff from endstops after homing
